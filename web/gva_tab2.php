...
<td>
	...
	<td>
		...
		<td  style='width:100px;height:45px;vertical-align:bottom'>
			<button onClick="window.open('profile_lines.php?seldbname=<?echo $seldbname?>&title=Profile_Lines','popuppage','width=450,height=220,left=250');">Profile Lines</button>
		</td>		
		<TD>
			<br>
