...
<form action="advancedjobuploader.php" method="post" enctype="multipart/form-data">
<input type="hidden" name="seldbname" value="<?echo $seldbname;?>">
<input type="hidden" name="MAX_FILE_SIZE" value="999999999">
<table class='container'>
<tr>
<td colspan='2'>
	<A href="advancedjobmanager.php?seldbname=<?echo $seldbname;?>"> Back to Advanced Manager </A>
	<br>
	<br>
	Job backup file:
</td>
