...
?>
   <LINK href="gva_tab1.css" rel="stylesheet" type="text/css">
   ...
   <TR>
       <TD>
           <TABLE style='margin: 2 0; padding: 0 0;' class='container'>
		       ...
		       <H2 style='line-height: 1.0;' align='center'>Administration Console</H2>
		       <p align="center">Version 2.2b (<?echo $_SERVER['SERVER_NAME']?>:<?echo $_SERVER['SERVER_PORT']?> - <?echo $hostname?>)</p>
		   </TD>
	   </TABLE>
	   <TABLE class='container'>
	       <TR>
	           <TD style='text-align: center;'>
		       <h2>Admin LOGIN: <font color="FF0000"> <? if ($_GET['login_err'] == 1) { echo "Login Failed"; }	       ?></font></h2>
		       <?
		       $log = new LogMeIn();
		       $log->encrypt = true;
		       $log->loginform("sgta_form","container","sgta_admin_login.php");
		       ?>
		   </TD>
	       </TR>
	  </TABLE>
