...
$fn=sprintf("./tmp/%s_gva_tab8.png", $seldbname);
$fnsnap=sprintf("./tmp/%s_gva_tab8snap.png", $seldbname);
$snaph=900;
$snapw=600;
...
if(!isset($cmd)) $cmd = '';
if($viewdspcnt>0) {
	$fn2=sprintf("./tmp/%s_gva_tab81.png", $seldbname);
	...
	<div>
		<div class='buttons' style='float:left;margin:2px'>
			<div style='float:left'>
				<input type=button name=choice onClick="window.open('splotconfig.php?seldbname=<?php echo $seldbname ?>&title=Survey%20Plot','popuppage','width=450,height=260,left=275');" value='Plot Surveys'>
			</div>
...
<?php
// -----------------------------------
// Starting the Target Tracker section
// -----------------------------------

include 'gva_tab8_tt.php';
?>

</div> <!-- end of tab container div -->
