...
$colortot=$_POST['colortot'];

$badshit=array("#");
$colortot=str_replace($badshit, "", $colortot);

require_once("dbio.class.php");
$db=new dbio($seldbname);
$db->OpenDb();

echo "UPDATE wellinfo SET colortot='$colortot'";
$db->DoQuery("UPDATE wellinfo SET colortot='$colortot';");
