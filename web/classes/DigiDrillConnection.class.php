...
class DigiDrillConnection extends WitsmlData {
		public $witsversion='1.3.1.1';
		public $soapv=SOAP_1_1;
		public $endpoint = "https://witsml.digidrill.com/WitsmlService.asmx";
		public $username = "geosteering@digidrill.com";
		public $password = "g30s733r!@#";
    ...
    function prepare_soap(){
    	if(!$this->client){
    		$this->client = new SoapClient(
    			'https://witsml.digidrill.com/WitsmlService.asmx?WSDL',
    			array(
