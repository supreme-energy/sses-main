...
<script type="text/javascript" charset="utf-8">
  $(document).ready(function() {
    $('#demo').hide();
    $('#picker').farbtastic('#colortot');
  });
</script>
<SCRIPT language="javascript">
function OnSubmit(rowform) {
	t = 'wellplancolortotd.php';
	t = encodeURI (t);
	rowform.action = t;
	rowform.submit();
	return true;
...
<td>
	<div class="form-item">
	<input style='color:white;' type="text" readonly='true' size='3' id="colortot" name="colortot" value="<?echo "#$colortot"?>" />
	</div>
</td>
</tr>
</table>
